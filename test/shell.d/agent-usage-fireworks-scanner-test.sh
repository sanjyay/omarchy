...
[[ $(jq -c '.record | {schemaVersion, id, ready, hasPromptStats, tierLabel, limits}' <<<"$result") == '{"schemaVersion":1,"id":"fireworks","ready":true,"hasPromptStats":false,"tierLabel":"Prepaid","limits":[]}' ]] ||
